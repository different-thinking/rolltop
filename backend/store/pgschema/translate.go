...
func translateColumn(definition string) (string, string, error) {
	...
	// AUTOINCREMENT accepts an explicit id on insert and the migration tool
	// copies ids verbatim, which GENERATED ALWAYS rejects with "cannot insert
	// a non-DEFAULT value into column".
