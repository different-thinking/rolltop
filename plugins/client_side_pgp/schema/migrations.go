...
func columnExists(ctx context.Context, tx *sql.Tx, table, column string) (bool, error) {
	var exists bool
	// to_regclass resolves the table the same way the ALTER TABLE that follows
	// will, which current_schema() does not on a server carrying a schema named
	// after the connecting role.
